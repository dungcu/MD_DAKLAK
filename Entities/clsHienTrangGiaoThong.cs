...
namespace MDSolution
{
    public class clsHienTrangGiaoThong
    {
		...
		public void Save(OleDbConnection cn, OleDbTransaction trans)
		{
			...
			{
                //id = lddata.MDSolutionEntities.DBModule.GetNewID(typeof(HienTrangGiaoThong), "tbl_HienTrangGiaoThong", cn, trans);
				ID = MDSolutionEntities.DBModule.GetNewID(typeof(clsHienTrangGiaoThong), "tbl_HienTrangGiaoThong", cn, trans);
			...
			/*
			if( ID <= 0 )
				ID = long.Parse(MDSolutionEntities.DBModule.ExecuteQueryGetOneResult("SELECT Max(ID) FROM tbl_HienTrangGiaoThong", cn, trans));
				*/
		}
