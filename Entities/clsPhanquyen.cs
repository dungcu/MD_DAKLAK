...
namespace MDSolution
{
    public class clsPhanquyen
    {
        ...
        public void Save(OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            {
                //id = lddata.MDSolutionEntities.DBModule.GetNewID(typeof(User), "sys_Roles_User_Cum", cn, trans);
                ID = MDSolutionEntities.DBModule.GetNewID(typeof(clsPhanquyen), "sys_Roles_User_Cum", cn, trans);
            ...
            /*
            if( ID <= 0 )
                ID = long.Parse(MDSolutionEntities.DBModule.ExecuteQueryGetOneResult("SELECT Max(ID) FROM sys_Roles_User_Cum", cn, trans));
                */
        }
