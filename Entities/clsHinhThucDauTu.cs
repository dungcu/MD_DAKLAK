...
namespace MDSolution
{
    public class clsHinhThucDauTu
    {
		...
		public void Save(OleDbConnection cn, OleDbTransaction trans)
		{
			...
			{
                //id = lddata.MDSolutionEntities.DBModule.GetNewID(typeof(HinhThucDauTu), "tbl_HinhThucDauTu", cn, trans);
				ID = MDSolutionEntities.DBModule.GetNewID(typeof(clsHinhThucDauTu), "tbl_HinhThucDauTu", cn, trans);
			...
			/*
			if( ID <= 0 )
				ID = long.Parse(MDSolutionEntities.DBModule.ExecuteQueryGetOneResult("SELECT Max(ID) FROM tbl_HinhThucDauTu", cn, trans));
				*/
		}
