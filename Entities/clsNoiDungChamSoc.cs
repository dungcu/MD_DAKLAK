...
namespace MDSolution
{
    public class clsNoiDungChamSoc
    {
		...
		public void Save(OleDbConnection cn, OleDbTransaction trans)
		{
			...
			{
                //id = lddata.MDSolutionEntities.DBModule.GetNewID(typeof(NoiDungChamSoc), "tbl_NoiDungChamSoc", cn, trans);
				ID = MDSolutionEntities.DBModule.GetNewID(typeof(clsNoiDungChamSoc), "tbl_NoiDungChamSoc", cn, trans);
			...
			/*
			if( ID <= 0 )
				ID = long.Parse(MDSolutionEntities.DBModule.ExecuteQueryGetOneResult("SELECT Max(ID) FROM tbl_NoiDungChamSoc", cn, trans));
				*/
		}
