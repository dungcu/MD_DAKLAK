...
namespace MDSolution
{
    public class CommonClass
    {
        ...
        {            
            ...
            MDSolutionEntities.NodeDonVi RootNode = new  MDSolutionEntities.NodeDonVi("0", "DACASUCO", DonviTypeHD.Root);
            NodeDonVi abc = new NodeDonVi("0", "", DonviTypeHD.Root);
            ...
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                ...
                ds1 = MDSolutionEntities.DBModule.ExecuteQuery(strSQL1, null, null);
        ...
        public static void loadTreeHopDongVanChuyen(System.Windows.Forms.TreeView tv)
        {
            ...
            node.ExpandAll();
            DataSet ds;
            string strSQL = "Select ID, TenChuHopDong as Ten from tbl_HopDongVanChuyen order by TenChuHopDong";
            ds = MDSolutionEntities.DBModule.ExecuteQuery(strSQL, null, null);
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                node1 = node.Nodes.Add(dr["ID"].ToString(), dr["Ten"].ToString());
        ...
        static public void ShowReport(string rptFileName, string rptTitle, string[] paraNames, object [] paraValues, Form frmParent)
        {
            ...
            DACASUCO.MDReport.Frm_ReportViewer frm = new DACASUCO.MDReport.Frm_ReportViewer();
            frm.bHasPara = true;
        ...
        static public DataSet ExecuteSP(string spName, string[] spParaName, string[] spParaValue)
        {
            ...
            OleDbConnection cn = new OleDbConnection(MDSolutionEntities.DBModule.strConnString);
