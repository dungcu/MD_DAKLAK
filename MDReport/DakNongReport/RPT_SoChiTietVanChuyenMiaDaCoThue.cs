...
{
    public partial class RPT_SoChiTietVanChuyenMiaDaCoThue : Form
    {
        public RPT_SoChiTietVanChuyenMiaDaCoThue()
        {
            InitializeComponent();
        }
        DataSet DS_CB = null;
       // public DataTable dtHopDong { get; set; }
        ...
        private void btnXemBC_Click(object sender, EventArgs e)//dtTuNgay.IsNullDate ? "20/11/2013" : ,dtDenNgay.IsNullDate ? "01/01/2014" :
        {
            long XeID=0;
            ...
            CommonClass.ShowReport("RPDakNong\\RPT_SoChiTietVanChuyenMiaDaCoThue.rpt", "Sổ chi tiết vận chuyển mía đã có thuế", paramNames, paraValues, null);
        }

        private void RPT_SoChiTietVanChuyenMiaDaCoThue_Load(object sender, EventArgs e)
        {
        ...
        private void LoadCBXe()
        {
            ...
            {
                DataSet ds = MDSolutionEntities.DBModule.ExecuteQuery("Select ID,SoXe from tbl_XeVanChuyen Where HopDongVanChuyenID="+cboHDVC.SelectedValue.ToString(), null, null);
