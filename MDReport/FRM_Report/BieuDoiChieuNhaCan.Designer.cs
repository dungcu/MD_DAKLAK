...
{
    partial class BieuDoiChieuNhaCan
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.lbTitle.Text = "Mấu đối chiếu nhà cân";
            ...
            uiComboBoxItem1.Text = "Danh  sách các xe có thời gian cân nhỏ hơn 60 phút";
            uiComboBoxItem1.Value = "VanChuyen\\\\MauKiemTraSoLieuCanMia\\\\DanhSachCacXeCanLienTiepNgay.rpt";
            uiComboBoxItem2.FormatStyle.Alpha = 0;
            uiComboBoxItem2.IsSeparator = false;
            uiComboBoxItem2.Text = "Danh sách các xe có trọng lượng bì chênh lệch quá 300 kg";
            uiComboBoxItem2.Value = "VanChuyen\\\\MauKiemTraSoLieuCanMia\\\\DanhSachCacXeCoTrongLuongChenhLechNgay.rpt";
            uiComboBoxItem3.FormatStyle.Alpha = 0;
            uiComboBoxItem3.IsSeparator = false;
            uiComboBoxItem3.Text = "Biểu khống chế nhà cân";
            uiComboBoxItem3.Value = "VanChuyen\\\\KhongCheNgay.rpt";
            ...
            this.Name = "BieuDoiChieuNhaCan";
            this.Text = "Biểu tổng hợp đối chiếu nhà cân";
            this.Load += new System.EventHandler(this.BieuDoiChieuNhaCan_Load);
